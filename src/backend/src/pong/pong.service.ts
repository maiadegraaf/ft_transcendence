...
export class PongService {
    ...
    async handleLeavePractice(client: Socket) {
        this.logger.log(client.id + ' left practice mode')
        delete this.practiceInstance[
            this.getPracticeInstanceByPlayerSocket(client.id).returnPracticeMatch().id
        ]
    }
}
