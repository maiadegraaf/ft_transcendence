  ...
  >
    ...
    <label for="practice-mode" class="m-4 flex items-center">
      ...
      <select
        ...
        class="px-4 py-2 text-2xl font-bold text-yinmn-blue focus:text-vista-blue rounded-lg border border-vista-blue border-solid focus:outline-none bg-vista-blue focus:outline-none focus:bg-yinmn-blue focus:outline-none focus:border-vista-blue"
      >
